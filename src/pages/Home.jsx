								...
								<div className="row">
									<div className="col-lg-7">
										<div className="text">
											...
											<p>Electro Homeopathic Clinic provides safe, natural, and effective homeopathic treatments using advanced electrohomeopathy techniques. Electro Homeopathy can be used by anyone of any age group who suffers from acute to chronic illnesses, for example, depression, arthiritis, migraine, ulcers or ME.</p>
							...
							<div className="col-lg-4 col-md-6 col-12">
								...
								<div className="single-schedule last">
									<div className="inner" style={{height: "100%"}}>
										<div className="icon">
											<i className="icofont-ui-clock" style={{top: "231px"}}></i>
										</div>
										<div className="single-content">
											<h4>Opening Hours</h4>
